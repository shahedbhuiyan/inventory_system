...
<table align="center" width="920" border="0">
	<tr><td colspan="5" height="90" bgcolor="#FEF200"><img src="image/banner.jpg" height="90" width="800" /></td></tr>
    ...
    <tr>
    	<td height="500" valign="top" width="160" bgcolor="#F0F0F0" rowspan="4">
            ...
            <table width="150" align="center" bgcolor="white" style="margin-top:7px; margin-bottom:7px" cellspacing="0" cellpadding="3">
            	<tr>
                	<td bgcolor="#CCCCCC" style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:#099; font-weight:bold">Banking</td>
                </tr>
                <tr>
                	<td bgcolor="#FFFFFF" valign="top">
                    	<table align="center" width="100%" style="font-family:Verdana, Geneva, sans-serif; font-size:11px">
                        	<tr><td><a href="create_account.php">Create Account</a></td></tr>
                            <tr><td><a href="view_account.php">View Account</a></td></tr>
                            <tr><td><a href="transection.php">Transection</a></td></tr>
                            <tr><td><a href="view_account.php">Transection Report</a></td></tr>
                        </table>
                    </td>
                </tr>
            </table>
