...
if($last_invoice_no != ''){
	@$paid_amount = $inv_obj->getPaidAmount($last_invoice_no);
	$delivery_info = $inv_obj->getDeliveryInfo($last_invoice_no);
	$item_record = $inv_obj->getItemRows($last_invoice_no); // item reocrd info
	$payment_mode = $inv_obj->getPaymentMode($last_invoice_no);
	$cust_id = $inv_obj->getCustomerId($last_invoice_no);
...
<table align="left" width="750" border="0" cellspacing="0">
    ...
    <tr>
        ...
        Invoice No : <?php echo @$last_invoice_no; ?><br />
